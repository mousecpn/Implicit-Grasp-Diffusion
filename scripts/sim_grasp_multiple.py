...
from igd.detection import VGN
from igd.detection_implicit import VGNImplicit
from igd.detection_igd import IGD

from igd.experiments import clutter_removal
from igd.utils.misc import set_random_seed
# import sys
# sys.path
import rospy
import os
...
def main(args):
    ...
    if args.type in ['giga', 'giga_aff']:
        grasp_planner = VGNImplicit(args.model,
                                    ...
                                    select_top=False,
                                    visualize=args.vis)
    elif args.type in ['igd']:
        grasp_planner = IGD(args.model,
                                    args.type,
                                    best=args.best,
                                    qual_th=args.qual_th,
                                    force_detection=args.force,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scene",
                        type=str,
                        choices=["pile", "packed", "real_packed","real_pile"],
                        default="pile")
